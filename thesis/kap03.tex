...
Mapování na cíle artefaktu (sekce~\ref{sec:cile-artefaktu}):
...
\begin{table}[ht]
\centering
\caption{Metrický rámec: kód, měřená vlastnost, nástroj a~exit kritérium}
...
P2 & Kvalita procesních artefaktů  & LLM-as-judge (GLM-5) & 3/3 \\
\midrule
\multicolumn{4}{@{}l}{\textit{Produktové (Q) --- co agent vyrobil}} \\
Q1 & Referenční test pass rate  & Vitest (40 behavioral testů) & 40/40 \\
...
Q7 & Cyklomatická složitost      & ESLint (complexity rule) & $\leq$ 10/fn \\
