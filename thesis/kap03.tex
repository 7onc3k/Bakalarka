...
\begin{itemize}
    \item \textbf{Model} -- Claude (Anthropic), fixní verze
...
Baseline (referenční implementace, human-guided, full spec + full scaffolding)
slouží jako gold standard. Počet a~výběr ablačních běhů závisí na dostupném
scope -- prioritu mají hypotézy s~nejsilnější oporou v~literatuře.
