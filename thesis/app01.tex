...
interpretaci výsledků a~nerozhodoval o~směru výzkumu. Pro
hodnocení části metrik (\acs{P6}, \acs{P7}, \acs{P8}, \acs{Q4},
\acs{Q8}) byla ve studii samostatně použita metoda
LLM-as-judge s~modelem GLM-5. Její role, omezení a~ověřitelnost
jsou popsány v~sekci~\ref{sec:llm-as-judge-aplikace}. Za celý
obsah práce nese plnou odpovědnost autor.
