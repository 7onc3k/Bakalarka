...
\begin{axis}[
    ...
    yticklabels={
        ...
        {\textcolor{cQual}{\textbf{Q2}} {\scriptsize(úspěšnost ref.\ testů)}},
...
\acs{Q1} a~\acs{Q6} byly splněny ve všech bězích, zatímco
\acs{Q2} nesplnil žádný autonomní běh.
\acs{Q3} splnil jeden ze~7 měřitelných běhů; u~2 běhů nebylo možné
mutation score vyhodnotit.
