...
metriky kvality kódu (\acs{Q5}--\acs{Q8}). Lulla et al.~\cite{lulla2026}
...
na procesní verifikaci --- stejný vzorec, který opravil \acs{P2}, \acs{P3}
...
kódem, čímž automaticky dodržuje P5 bez explicitního zákazu.
\end{raw}
