...
\usepackage{placeins}       % bariéry pro tabulky a obrázky / barriers for floats
\makeatletter
...
\newcolumntype{M}{>{\raggedright\arraybackslash}p{0.23\linewidth}}
...
\usepackage{caption}
\counterwithout{table}{chapter} % prubezne cislovani tabulek v cele praci
\counterwithout{figure}{chapter} % prubezne cislovani obrazku v cele praci
\makeatletter
\AtBeginDocument{%
  \@ifundefined{c@lstlisting}{}{\counterwithout{lstlisting}{chapter}}%
} % prubezne cislovani vypisu v cele praci
\makeatother
\usepackage{enumitem}
...
%%% Dvě dimenze: CO měříme (P/Q/E) a JAK měříme (deter./judge-based)
\usepackage{acro}
\usepackage{etoolbox}
...
\DeclareAcronym{P6}{short=P6, long=kvalita commit messages, tag=process}
\DeclareAcronym{P7}{short=P7, long=kvalita issue descriptions, tag=process}
\DeclareAcronym{P8}{short=P8, long=kvalita PR descriptions, tag=process}

% --- Produktové metriky (Q) ---
\DeclareAcronym{Q1}{short=Q1, long=API contract match, tag=quality}
\DeclareAcronym{Q2}{short=Q2, long=úspěšnost referenčních testů, tag=quality}
...
\DeclareAcronym{Q7}{short=Q7, long=porušení složitosti, tag=quality}
\DeclareAcronym{Q8}{short=Q8, long=design quality, tag=quality}

% --- Metriky zdrojů (E) ---
\DeclareAcronym{E1}{short=E1, long=vstup/výstup/cache tokeny, tag=resources}
\DeclareAcronym{E2}{short=E2, long=trvání, tag=resources}
\DeclareAcronym{E3}{short=E3, long=počet kompakcí, tag=resources}
...
\newcommand{\mgrp}[1]{%
  ...
  \ifstrequal{#1}{E}{\hyperref[tab:metriky-prehled]{metriky zdrojů (E1--E3)}}{}%
}

% --- Skupiny: JAK měříme ---
% Použití: \mmet{det}, \mmet{qual}
\newcommand{\mmet}[1]{%
  \ifstrequal{#1}{det}{\hyperref[tab:metriky-prehled]{deterministické metriky}}{}%
  \ifstrequal{#1}{qual}{\hyperref[tab:metriky-prehled]{judge-based metriky}}{}%
}
