% Nastavení biblatex dle FIS šablony (APA)
% Zdroj: handoffs/assets/fis/downloads/BP-DP/SablonaBP-DP/biblatex-setup.tex
...
% Soubor czech-apa.lbx nemusí být v minimální TeX distribuci; bez mapování hlásí biblatex chybu.
\DeclareLanguageMapping{czech}{english}
...
% Zkrácení seznamu autorů v citacích (APA et al.)
\makeatletter
