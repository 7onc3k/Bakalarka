...
Výsledky jsou navíc specifické pro OpenCode a~model Minimax;
...
\paragraph{Požadavky na kvalitu operacionalizovat jako verifikační kroky.}
...
pracovního postupu (sekce~\ref{sec:ablace-a}). Breunig~\cite{breunig2025}
...
příkazu, tím spolehlivěji ji agent dodržuje. Doporučení: každý měřitelný požadavek na kvalitu převést na
