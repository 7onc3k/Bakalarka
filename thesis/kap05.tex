...
jednoho souboru. Deterministické metriky
...
celistvý: žádný běh nevyčerpal kontextové okno a~runtime nemusel
historii zhušťovat. \acs{E3} je proto deskriptivní indikátor stability
runtime, ne pass/fail kritérium; na této úloze plní roli kontextového
faktu, že naměřené hodnoty ostatních metrik nebyly zkresleny ztrátou
...
Dvě pass/fail kritéria (\acs{Q1}, \acs{Q6}) byla splněna ve všech
...
ale ne monotónnímu. Baseline (r1) splnila pouze \acs{P1}, \acs{P4},
\acs{Q1} a~\acs{Q6}; po dvou cyklech úprav (r3) agent splnil celý
procesní checklist \acs{P1}--\acs{P5} a~současně udržel \acs{Q1}
i~\acs{Q6}. Regrese r4 vrátila procesní část zpět ($\sim$3/5)
a~ukázala, že zlepšení není trvalé: po neúspěšné iteraci bylo nutné
...
\textbf{Nerozlišující pass/fail kritéria.}
...
model nízkonákladové. \acs{E3} je deskriptivní indikátor (ne pass/fail
kritérium) a~ve všech bězích~=~0; pro tuto úlohu má roli kontextového
faktu o~stabilitě runtime, na rozsáhlejších projektech by mohla
diskriminovat výrazněji.
...
na jiný model nebo projekt jen po přizpůsobení metrik a~prahů
danému prostředí. Podmínkou je sada metrik pokrývající více dimenzí
