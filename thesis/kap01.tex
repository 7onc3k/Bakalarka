...
Ukazuje se, že odpověď leží spíš v~instrukcích než v~samotných modelech. Breunig \cite{breunig2025} zjistil, že změna promptu mění chování agenta výrazněji než výměna modelu. Lulla et al. \cite{lulla2026} dokládají, že přítomnost instrukčního souboru (AGENTS.md) je spojena se zkrácením mediánové doby běhu o~28,6\,\% a~snížením výstupních tokenů o~16,6\,\%. Scaffolding --- struktura instrukcí a procesních pravidel, která agenta provází vývojem --- má na výsledek zásadní vliv. Ale nikdo systematicky nezkoumal, \emph{které} složky tohoto scaffoldingu jsou pro dodržování softwarově-inženýrských praktik nezbytné a které jsou zbytečné.
